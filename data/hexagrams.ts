// 《易经》六十四卦：卦名、卦辞、爻辞（通行本，公有领域）

export interface Hexagram {
  id: number; // 1–64，通行本卦序（乾1、坤2、屯3……未济64）
  name: string; // 卦名，如 "乾为天"、"水雷屯"
  upperTrigram: string; // 上卦（外卦）三爻卦名，八经卦之一：乾、坤、震、巽、坎、离、艮、兑
  lowerTrigram: string; // 下卦（内卦）三爻卦名
  guaCi: string; // 卦辞原文，如 "乾：元，亨，利，贞。"
  yaoCi: string[]; // 六爻爻辞原文，从初爻到上爻恰好 6 条（乾卦附用九、坤卦附用六，并入数组末尾作为第 7 条，仅乾坤两卦如此）
}
